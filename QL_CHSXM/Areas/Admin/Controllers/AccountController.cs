...
namespace QL_CHSXM.Areas.Admin.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult SidebarUserInfo()
        {
            ...
            string fullName = user != null ? user.FullName : "Khách hàng"; // Nếu không tìm thấy user, hiển thị là Guest
        ...
        public ActionResult Index(int? page)
        {
            ...
            var users = db.Users.OrderBy(u => u.UserName).ToPagedList(pageNumber, pageSize); // Phân trang danh sách người dùng
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    if (user != null)
                    {
                        ...
                        {
                            ModelState.AddModelError("", "Chỉ tài khoản quản trị viên mới được đăng nhập.");
                            return View(model);
                        }
                    }
